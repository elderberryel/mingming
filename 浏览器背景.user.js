...
[class*="bg"],[class*="Bg"],[class*="color-bg"],[class*="ColorBg"],[class*="bgColor"],.Box,.Box-body,.Box-header,.file-navigation,.repository-content,.AppHeader,.Layout-sidebar,.Layout-main,.UnderlineNav,.BorderGrid,.flash,.modal,.modal-dialog,.modal-body,.drawer,.drawer-body,.diff-table,.diff-header,.blob-code,.blob-num,.file,.file-header,.commit,.timeline-comment,.review-comment,.inline-comment-form,.select-menu,.dropdown,.Popover,.overlay,.signed-commit,.blankslate,.paginate-container,.pagination,.State,.Label,.Counter,.TimelineItem,.commit-ref,.sha,.IssueLabel,[class*="IconButton"],[class*="ButtonBase"],[class*="NavigationMenu"],[data-component="IconButton"],button,summary{background:transparent!important;background-color:transparent!important;background-image:none!important;box-shadow:none!important;border-color:transparent!important;}
