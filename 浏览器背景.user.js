  ...
  background-color:rgba(255,255,255,0.08)!important;
    ...
    function stripXHeaderBlur() {
        ...
        function clearBlur(el, st) {
            ...
            if (isProtected(el)) return;   // 守卫：下拉/搜索建议/菜单不动
        ...
        function stripHeaderFromAnchor(anchor) {
            ...
            // 向上找承载 sticky/fixed/backdrop 的头部容器
