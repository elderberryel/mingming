...
const NAV_SEL='#submenu,#menu,#nav,#navbar,#navigation,#topnav,#top-nav,#mainnav,#main-nav,#globalnav,.submenu,.sub-nav,.subnav,.nav-wrap,.nav-container,.main-nav,.top-nav,.global-nav,header nav,nav ul,nav';
