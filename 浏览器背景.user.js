...
(function () {
    ...
    const DEFAULTS = { url: 'https://i.postimg.cc/050FJB6B/73AF378C-7257-4873-A4C4-376B59A7CD8F.jpg', theme: 1, opacity: 0.69, blur: 0, enabled: true, floatVisible: true, listMode: 'blacklist', floatPos: { right: 10, bottom: 90 }, nativeElementBlur: 10, overlayBlur: 10, overlayAlpha: 0.10 };
...
.GlobalNav,.UnderlineNav,.LocalNavigation,[class*="UnderlineNav"],[class*="GlobalNav"]{backdrop-filter:none!important;-webkit-backdrop-filter:none!important;}`;
    ...
    function getNativeBlurCSS(blurAmount, theme) {
        ...
        const GLASS_FILTER = `blur(${blurAmount}px) saturate(105%)`;

        const glassBg = isDark ? 'rgba(28,30,38,0.28)' : 'rgba(255,255,255,0.22)';
        const xDropdownBorder = isDark ? 'rgba(255,255,255,0.18)' : 'rgba(255,255,255,0.55)';
        const xHoverBg = isDark ? 'rgba(255,255,255,0.12)' : 'rgba(0,0,0,0.08)';

        const glassHighlight = isDark ? 'rgba(255,255,255,0.14)' : 'rgba(255,255,255,0.7)';
        const glassShadow = isDark ? 'rgba(0,0,0,0.5)' : 'rgba(0,0,0,0.18)';
        const GLASS_SHADOW = `0 8px 32px ${glassShadow}, inset 0 1px 1px ${glassHighlight}, inset 0 -1px 2px rgba(0,0,0,0.06)`;
        ...
        const SLOT_POPUP_CHILD = '[data-slot="select-content"] *:not(img),[data-slot="dropdown-menu-content"] *:not(img),[data-slot="popover-content"] *:not(img),[data-slot="context-menu-content"] *:not(img),[data-slot="menubar-content"] *:not(img),[data-slot="navigation-menu-content"] *:not(img),[data-slot="hover-card-content"] *:not(img),[data-slot="tooltip-content"] *:not(img),[data-slot="combobox-content"] *:not(img),[data-slot="command"] *:not(img),[data-slot="command-list"] *:not(img),[data-slot="select-popup"] *:not(img),[data-slot="menu-popup"] *:not(img),[data-slot="popover-popup"] *:not(img),[data-slot="tooltip-popup"] *:not(img)';
        ...
        // 这些弹层的定位壳子常带 filter，会破坏后代 backdrop-filter，需清除
        ...
        const DROP_CHILD = '[id^="typeaheadDropdown"] *:not(img),.search-suggest *:not(img),.sug-list *:not(img),.s-sug *:not(img),[class*="suggest"] *:not(img),[id*="search-result"] *:not(img),[id*="search-results"] *:not(img),[class*="search-result"] *:not(img),[role="listbox"] *:not(img),[role="menu"] *:not(img),[id^="base-ui-"][id$="-list"] *:not(img),[id^="base-ui-"][id$="-popup"] *:not(img),' + SLOT_POPUP_CHILD;
        return `
.modal,.dialog,.popup,.dropdown,.menu,.popover,.tooltip,[role="dialog"],[role="menu"],[role="tooltip"],[role="listbox"],[role="grid"],.layer,.fancybox,.swal-modal,.ant-modal,.el-dialog,.el-popper,.notification,.Toastify__toast-container,.position-fixed,.z-50{backdrop-filter:${GLASS_FILTER}!important;-webkit-backdrop-filter:${GLASS_FILTER}!important;box-shadow:${GLASS_SHADOW}!important;}
${DROP}{backdrop-filter:${GLASS_FILTER}!important;-webkit-backdrop-filter:${GLASS_FILTER}!important;background-color:${glassBg}!important;border:1px solid ${xDropdownBorder}!important;box-shadow:${GLASS_SHADOW}!important;border-radius:12px!important;transform:translateZ(0)!important;isolation:isolate!important;overflow:hidden!important;}
${DROP_CHILD}{background-color:transparent!important;box-shadow:none!important;}
${POPUP_UNFILTER}{filter:none!important;}
${POPUP_PANEL}{backdrop-filter:${GLASS_FILTER}!important;-webkit-backdrop-filter:${GLASS_FILTER}!important;background-color:${glassBg}!important;border-radius:12px!important;box-shadow:${GLASS_SHADOW}!important;isolation:isolate!important;}
${POPUP_LEAF}{background-color:transparent!important;box-shadow:none!important;}
...
[data-testid="primaryColumn"] div:has(> div > [data-testid="app-bar-back"]),
...
[data-testid="primaryColumn"] .r-17c3jg3{background-color:transparent!important;}
...
nav[aria-live="polite"][role="navigation"] div[role="tab"]{background-color:transparent!important;-webkit-backdrop-filter:none!important;backdrop-filter:none!important;}`;
    ...
    function isTiebaSite() { return /(^|\.)tieba\.baidu\.com$/.test(getHost()); }

    function getTiebaCSS() {
        return `
/* ===== 贴吧目录页 (/f?kw=) ===== */
.forum_content,.forum_content .main,#content_wrap,
.content_leftList,.j-content-leftList,
.thread_list_bottom,.th_footer_bright,.th_footer_l,
#frs_list_pager,.pagination-default,
.aside,#aside,
[id^="pagelet_frs-list"],[id^="pagelet_platform"],[id^="pagelet_live"],[id^="pagelet_frs-aside"],
.forum_content .thread_list,.forum_content li,.forum_content .t_con,
/* ===== 贴吧帖子页 (/p/) ===== */
.pb_content,.left_section,.right_section,
.core_title_wrap_bright,.core_title_bg,.j_core_title_bg,.tittle_fill_dom,
.p_postlist,.l_post,.l_post_bright,.j_l_post,
.d_post_content_main,.d_post_content,.p_content,
.core_reply,.core_reply_wrapper,.core_reply_content,.j_lzl_container,
.core_reply_tail,.post-tail-wrap,
.pb_footer,.p_thread,.thread_theme_5,.thread_theme_7,.l_thread_info,
.card_top_wrap,.card_top,.card_title,.card_head,.card_num,
.sign_mod_bright,#sign_mod,
.region-login,#embedded-login,.region_bright,.app_download_box,
.topic_list_box,.topic_list,.item_hd,
#tieba-notice,.unordered-list,
.tb_rich_poster_container,.tb_rich_poster,.poster_head,.poster_body,
.editor_wrapper,.editor_content_wrapper,.ueditor_container,
.old_style_wrapper,.edui-container,.edui-editor-body,.edui-editor-middle,
.edui-body-container,.poster_component,.editor_bottom_panel,
.right_section .region_bright,#pb_content,#thread_theme_5,#thread_theme_7,
/* 导航栏 */
.nav_wrap,.nav_wrap_add_border,#tb_nav,.nav_list,.j_nav_list,.j_tbnav_tab,
/* ===== 贴吧首页 (个性动态/推荐页) ===== */
.content-sec,.left-sec,.right-sec,.r-top-sec,.r-left-sec,.r-right-sec,
.left-cont-wraper,#left-cont-wraper,
.aggregate_entrance_wrap,.aggregate_entrance_title,.entrance_item,
.u-f-t,.f-d-w,#f-d-w,.f-d-item,.f-d-item-content,.directory-wraper,.all-wraper,.all,.more-txt,.center-fixed,
.forum_rcmd,#forum_rcmd,.class_title,.hot_icon_wrap,
.rcmd_forum_list,.rcmd_forum_item,.rcmd_forum_link,.rcmd_forum_info,
.sub_nav_wrap,.sub_nav_list,.nav_bar_fixd,#sub_nav_wrap,
#like-tag-nav,#info-section,
.new_list,#new_list,.j_feed_li,.n_right,.n_txt,.n_reply,.n_img,
.title-tag-wraper,.thread-name-wraper,.list-post-num,
.right_wrap,#right_wrap,.notice_item,#notice_item,.notice_list,.notice,
.topic_list_hot,.topic_item,.btn_more,.data_loading,.data_error_bar,
.lu-home-wrapper,.lu-home-wrapper-seat{
  background:transparent!important;background-color:transparent!important;
  background-image:none!important;box-shadow:none!important;border-color:transparent!important;
}
/* 分页/按钮：只透明底、保留细边框以便可见 */
#frs_list_pager .pagination-item,.pagination-default .pagination-item,
.pager_theme_4 a,.pager_theme_5 a{
  background:transparent!important;background-color:transparent!important;
  border-color:rgba(255,255,255,0.3)!important;
}
/* 签到按钮：功能按钮，给半透明底+边框以便可见可点 */
.j_signbtn,.sign_btn_bright{
  background:rgba(0,0,0,0.25)!important;background-color:rgba(0,0,0,0.25)!important;
  background-image:none!important;box-shadow:none!important;
  border:1px solid rgba(255,255,255,0.3)!important;border-radius:6px!important;
}
/* 首页帖子列表条目：加细分隔线，避免全透后条目糊在一起 */
.j_feed_li{border-bottom:1px solid rgba(255,255,255,0.12)!important;}
/* 登录表单输入框：贴吧登录框需要能看清，给个浅色底 */
.pass-text-input{
  background-color:rgba(255,255,255,0.9)!important;color:#333!important;
}
/* 富文本编辑器输入区：给个浅底方便打字 */
.edui-body-container,#ueditor_replace{
  background-color:rgba(255,255,255,0.08)!important;
    ...
    function stripXHeaderBlur() {
        ...
        function isProtected(el) {
            ...
            try { return !!el.closest(X_DROPDOWN_GUARD); } catch (e) { return false; }
        }

        function isGlassBg(bg) {
            if (!bg || bg === 'transparent' || bg === 'rgba(0, 0, 0, 0)') return false;
            const nums = bg.match(/[\d.]+/g);
            if (!nums || nums.length < 3) return false;
            const r = +nums[0], g = +nums[1], b = +nums[2], a = nums.length >= 4 ? +nums[3] : 1;
            if (a < 1) return true;
            return (Math.max(r, g, b) - Math.min(r, g, b)) < 24;
        }
        function clearBlur(el, st) {
            ...
            if (isGlassBg(st.backgroundColor || '')) el.style.setProperty('background-color', 'transparent', 'important');
        }
        function stripHeaderFromAnchor(anchor) {
            if (!anchor) return;
            const col = anchor.closest ? anchor.closest('[data-testid="primaryColumn"]') : null;
            const stop = col || document.body;
            ...
            if (isProtected(header)) return;
            clearBlur(header);
            let p = header.parentElement, hop = 0;
            while (p && p !== stop && p !== document.body && hop < 5) { clearBlur(p); p = p.parentElement; hop++; }

            const kids = header.getElementsByTagName('*');
            for (let j = 0; j < kids.length; j++) clearBlur(kids[j]);
        }

        document.querySelectorAll('[data-testid="app-bar-back"]').forEach(stripHeaderFromAnchor);
        document.querySelectorAll('nav[aria-live="polite"][role="navigation"]').forEach(nav => {
            stripHeaderFromAnchor(nav);
            if (!isProtected(nav)) {
    ...
    function buildCSS(cfg, finalUrl) {
        let css = getBackgroundCSS(cfg, finalUrl) + getThemeCSS(cfg.theme)
            ...
            + `.ant-menu.ant-menu-horizontal,.ant-menu-root.ant-menu-horizontal,ul.ant-menu.ant-menu-horizontal,.ant-menu-horizontal>.ant-menu-item,.ant-menu-horizontal>.ant-menu-submenu,.ant-menu-horizontal .ant-menu-submenu-title,.ant-btn.ant-btn-default,.ant-btn-variant-outlined,button.ant-btn{background:transparent!important;background-color:transparent!important;box-shadow:none!important;border-color:rgba(255,255,255,0.3)!important;}`
    ...
    function findVisibleCaptcha() {
        if (!document.body) return false;
        for (const sel of CAPTCHA_SELECTORS) {
            try {
                const nodes = document.body.querySelectorAll(sel);
                for (let i = 0; i < nodes.length; i++) {
                    if (isRealCaptcha(nodes[i])) return true;
                }
            } catch (e) {}
        }
        return false;
    ...
    function writeOverlay(item, blur, alpha) {
        const el = item.el;
        const glassFilter = `blur(${blur}px) saturate(105%)`;
        el.style.setProperty('backdrop-filter', glassFilter, 'important');
        el.style.setProperty('-webkit-backdrop-filter', glassFilter, 'important');
        el.style.setProperty('background-color', item.useWhite ? `rgba(255,255,255,${alpha})` : `rgba(0,0,0,${alpha})`, 'important');
        el.style.setProperty('box-shadow', item.useWhite
            ? 'inset 0 1px 1px rgba(255,255,255,0.65), 0 8px 32px rgba(0,0,0,0.15)'
            : 'inset 0 1px 1px rgba(255,255,255,0.14), 0 8px 32px rgba(0,0,0,0.45)', 'important');
    ...
    function applyImportedConfig(data) {
        ...
        _liveOverlayBlur = null; _liveOverlayAlpha = null; _livePreviewConfig = null; invalidateConfig(); applyAgain();
    }
...
`;
    ...
    function resetLivePreview() {
        if (_liveOverlayBlur !== null || _liveOverlayAlpha !== null || _livePreviewConfig !== null) {
            _liveOverlayBlur = null; _liveOverlayAlpha = null; _livePreviewConfig = null;
        }
        applyStyle();
        requestOverlayApply();
    }
...
<div class="row"><div class="lab">自动弹层透明 <span id="oaTxt">${cfg.overlayAlpha.toFixed(2)}</span></div><input id="oaR" type="range" min="0" max="80" step="1" value="${Math.round(cfg.overlayAlpha*100)}"></div>`;
        ...
        shadow.getElementById('saveG').addEventListener('click', e => {
            ...
            _liveOverlayBlur=null; _liveOverlayAlpha=null; _livePreviewConfig=null; applyAgain(); alert('已保存到全局配置');
        });
        ...
        shadow.getElementById('saveS').addEventListener('click', e => {
            ...
            _liveOverlayBlur=null; _liveOverlayAlpha=null; _livePreviewConfig=null; applyAgain(); alert('已保存到本站配置');
        });

        shadow.getElementById('pickG').addEventListener('click', e => { e.stopPropagation(); pickLocalImage((u,f)=>{ setValue(KEYS.url,u); invalidateConfig(); gUrlEl.value=''; sUrlEl.value=''; _livePreviewConfig=null; _liveOverlayBlur=null; _liveOverlayAlpha=null; applyAgain(); alert('已设置全局本地图片：'+f.name); }); });
        shadow.getElementById('pickS').addEventListener('click', e => { e.stopPropagation(); pickLocalImage((u,f)=>{ setSiteConfig(getHost(),Object.assign({},getSiteConfig(getHost())||{}, {url:u})); invalidateConfig(); sUrlEl.value=''; gUrlEl.value=''; _livePreviewConfig=null; _liveOverlayBlur=null; _liveOverlayAlpha=null; applyAgain(); alert('已设置本站本地图片：'+f.name); }); });
        ...
        shadow.getElementById('resetG').addEventListener('click', e => {
            ...
            updateTxt(); _liveOverlayBlur=null; _liveOverlayAlpha=null; _livePreviewConfig=null; applyAgain(); alert('已恢复全局默认值');
        });
        ...
        shadow.getElementById('resetS').addEventListener('click', e => {
            ...
            updateThemeTxt(); [opR,blR,nbR,obR,oaR].forEach(updateSliderTrack);
            updateTxt(); _liveOverlayBlur=null; _liveOverlayAlpha=null; _livePreviewConfig=null; applyAgain(); alert('已清除当前站点配置');
        });
