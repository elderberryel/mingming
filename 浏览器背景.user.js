...
const SCRIPT_VERSION=(typeof GM_info!=='undefined'&&GM_info&&GM_info.script&&GM_info.script.version)||'5.7';
...
deepseekOverlayCSS(blur,alpha){
 const b=Number(blur)||0,a=Number(alpha);const alphaVal=Number.isFinite(a)?Utils.clamp(a,0,.8):.1;
 const gf=b>0?`blur(${b}px) saturate(105%)`:'none';
 const bg=`rgba(0,0,0,${alphaVal})`;
 return `._871cbca,.d72636e2,.aaff8b8f,.ec4f5d61,.f79352dc,._245c867._34a54ec,._245c867,._34a54ec{background:${bg}!important;background-color:${bg}!important;background-image:none!important;backdrop-filter:${gf}!important;-webkit-backdrop-filter:${gf}!important;box-shadow:none!important;border-color:transparent!important;}`;},
stripXHeaderBlur(){
