  ...
  const setLink = function(node) {
    ...
    while ((match = urlRegex.exec(content)) !== null) {
      ...
      if (isEmail && offset < offsetAdjustment) {
        ...
        hasMatch = true;
        let a = document.createElement('a'); a.href = 'mailto:' + url; a.textContent = url; a.target = "_blank"; a.rel = "noopener noreferrer"; a.className = "gm-text-to-link"; a.style.cssText = "text-decoration: underline; color: #98DD98 !important;";
      ...
      a.textContent = url; a.target = "_blank"; a.rel = "noopener noreferrer"; a.className = "gm-text-to-link"; a.style.cssText = "text-decoration: underline; color: #98DD98 !important;";
      fragment.appendChild(a);
      if (!isEmail && !isSpecialProto) {
